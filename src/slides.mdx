...
[![Edit trusting-http-qhrnek](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/trusting-http-qhrnek?fontsize=14&hidenavigation=1&theme=dark)
...
[![Edit objects-and-arrays](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/amazing-platform-zqfbng?fontsize=14&hidenavigation=1&theme=dark)
...
[![Edit functions-with-objects-and-arrays](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/functions-with-objects-and-arrays-2vl0mi?fontsize=14&hidenavigation=1&theme=dark)
...
const picked = list.find((item) => { item.id === 2 });
...
[![Edit array-methods](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/array-methods-dztykn?fontsize=14&hidenavigation=1&theme=dark)
